...
public class WhiteBoardPopulator implements BoardPopulator {
    ...
    public void populateBoard(Board board) {
        ...
        for (int row = 8; row >= 1; row--) {
            ...
            for (char col = 'a'; col <= 'h'; col++) {
                ...
                // enable white player to click on white pieces or empty positions in initial state
                if (Client.isWhite() && (piece == null || piece.getColor() == Piece.PieceColor.White))
